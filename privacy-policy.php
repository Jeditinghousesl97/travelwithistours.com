...
<!-- Page Header -->
<section class="page-header" style="background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('assets/images/headers/privacy-policy.webp'); background-color: #333; padding: 100px 0; text-align: center; background-size: cover; background-position: center; position: relative;">
    <div class="container" style="position: relative; z-index: 2;">
        <h1 style="font-family: 'Playfair Display', serif; font-size: 48px; color: #fff; margin-bottom: 10px;">Privacy Policy</h1>
        <p style="color: #eee; font-size: 18px; max-width: 600px; margin: 0 auto;">Your privacy is important to us. Learn how we handle your data.</p>
    </div>
</section>
...
<section class="section" style="padding: 80px 0; background: #fff;">
    <div class="container">
        <div style="max-width: 900px; margin: 0 auto; color: #444; line-height: 1.8;">
            ...
            <h2 style="color: #333; margin-bottom: 20px;">5. Third-Party Links</h2>
            ...
            <h2 style="color: #333; margin-bottom: 20px;">6. Consent</h2>
